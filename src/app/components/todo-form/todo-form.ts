  ...
  template: `
    <form (submit)="onSubmit($event)" class="mb-6" aria-label="Add new todo">
      <div class="flex gap-2">
        <label for="todo-input" class="sr-only">New todo title</label>
        <input
          id="todo-input"
        ...
        <button
          type="submit"
          class="px-6 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 disabled:bg-gray-300 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
